...
def LP_weekday():
    ...
    count = 1
    # store 51 makes solution not optimal (stores 5-66 can be optimal, 4-66 not)
    indexes2 = list(range(1, 4))
    indexes2.extend(list(range(5, 56)))
    indexes2.extend(list(range(57, 67)))
    for k in indexes2:
